...
const Dashboard = () => {
    ...
    return (
        <Box m = "20px">
            ...
            {/* GRID AND CHARTS */}
            <Box display = "grid" gridTemplateColumns = "12, 1fr" gridAutoRows="140px" gap = "20px">
              ...
              {/* ROW 2 */} 
                <Box gridColumn = "span 8" gridRow = "span 2" sx ={{backgroundColor : colors.primary[400]}}> 
                    ...
                    <Box mt = "25px" p = "0 30px" display="flex" justifyContent="space-between" alignItems="center">
                        ...
                        <Box>
                            <Typography sx = {{variant : "h5", fontWeight: "600", color: colors.grey[100]}}>
                                Collisions Avoided
                            </Typography>

                            <Typography sx = {{variant : "h3", fontWeight: "bold", color: colors.greenAccent[500]}}>
                                21
                            </Typography>
                        </Box>
